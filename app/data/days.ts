...
export const DAYS: Day[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { place: 'sofa', minutes: 10, karten: ['falle'], what: 'Die <b>30-Sekunden-Routine</b>: sechs neue Karten. Danach deine fünf Zeichen aufschreiben — eins pro Scharnier.', en: 'The 30-second routine: six new cards. Then write your five marks down — one per hinge word.', note: 'Teil 1 kalt war 2/5. Nicht das Ohr, sondern die Lesezeit: 30 Sekunden für fünf Aussagen sind 6 Sekunden pro Satz.' },
      ...
      { place: 'sofa', minutes: 35, datei: 'telc-b1-uebungstest-4-hoerverstehen.mp3', what: '<b>Zugabe, nur wenn die ÜT4-Datei schon auf dem Handy ist:</b> das ganze Hörverstehen am Stück, mit Aufgabenblatt.', en: 'Encore, only if the ÜT4 file is already on your phone: the whole listening paper in one go, with the answer sheet.', note: 'Ohne die Datei ist der Tag trotzdem voll. Sonntag holen wir die Datei aufs Handy — dann steht der zweite Durchgang zum Ziel 16/20.' },
  ...
  },
  {
    ...
    slots: [
      { place: 'gym', minutes: 10, karten: true, what: 'Nur Karten — kein neues Hören vor der Sitzung.', en: 'Cards only — no new listening before the sitting.' },
      { place: 'sofa', minutes: 35, hoeren: ['eigen-01-teil2'], what: '<b>Teil 2, einmal gehört, mit Uhr.</b> Direkt danach: schick mir die Antworten.', en: 'Teil 2, heard once, on the clock. Straight afterwards, send me your answers.', note: 'Kalt heißt kalt: keine Vorschau auf die Aussagen jenseits der vorgesehenen Lesezeit.' },
      { place: 'bed', minutes: 10, what: '🗣 <b>KI-Runde, 10 Minuten</b> — Teil 3 mit der Sprach-KI. Prompt und Regeln stehen unter <i>Sprechen</i>. Danach drei Sätze aufschreiben, die dir im Gespräch gefehlt haben.', en: 'Speaking round, 10 minutes — Teil 3 with the voice AI. The prompt and the rules are on the Sprechen page. Afterwards write down three sentences you were missing.', note: 'Statt drei geschriebener Sätze: dieselben drei Sätze, aber laut und in einem Gespräch. Wortfeld <b>Arbeit</b>.' },
    ],
    deck: ['falle'],
  },
  {
    ...
    slots: [
      { place: 'gym', minutes: 12, karten: true, what: 'Kartenrunde <b>Fallen</b>. Diese sieben Karten sind die ganze Theorie.', en: 'Card round: traps. These seven cards are the entire theory.' },
      { place: 'sofa', minutes: 35, what: 'Jeder Fehler von gestern wird eingeordnet: Paraphrase, Wortgleichheit, Absolutizer, Verneinung, Schluss. Dann 20 Aussagen im Chat, ✓ oder ✗.', en: 'Every mistake from yesterday gets classified: paraphrase, word-match, absolutizer, negation, inference. Then 20 statements in chat, ✓ or ✗.' },
  ...
  },
  {
    ...
    slots: [
      { place: 'gym', minutes: 15, hoeren: ['eigen-01-teil2'], what: 'Teil 2 noch einmal hören — ohne Aufgabenblatt, nur zuhören.', en: 'Listen to Teil 2 again — no answer sheet, just listen.', note: 'Beim zweiten Hören ohne Papier hörst du plötzlich Sätze, die vorher nicht da waren.' },
      { place: 'sofa', minutes: 35, hoeren: ['eigen-01-teil2'], what: 'Jetzt mit Aufgabenblatt, Ziel <b>≥ 8/10</b>. Danach Transkript mitlesen und jeden Distraktor markieren.', en: 'Now with the answer sheet, target ≥ 8/10. Then read along with the transcript and mark every distractor.', note: 'Der alte Versuch bleibt stehen — du siehst beide Zahlen untereinander.' },
  ...
  },
  {
    ...
    slots: [
      ...
      { place: 'sofa', minutes: 35, what: 'Ein Brief, <b>30 Minuten, auf Papier, mit Uhr</b>. Dann abfotografieren und mir schicken.', en: 'One letter, 30 minutes, on paper, on the clock. Then photograph it and send it to me.', note: 'Checkliste vorher lesen: Betreff · Anrede + Gruß · alle 4 Leitpunkte · Schluss mit einer Frage.' },
    ],
    deck: ['brief', 'gramm'],
  },
  {
    ...
    slots: [
      { place: 'sofa', minutes: 150, datei: 'telc-b1-uebungstest-4-hoerverstehen.mp3', what: 'Drei Teile hintereinander, mit Uhr, ohne Pause dazwischen.', en: 'Three Teile back to back, on the clock, no break between them.', note: 'Die Rampe: letzte Woche 2 Teile, heute 3.' },
  ...
  },
  {
    ...
    slots: [
      ...
      { place: 'sofa', minutes: 40, what: 'Ergebnisse an mich → Fehleranalyse → Ledger. <b>Und den Test für nächste Woche nennen.</b>', en: 'Results to me → error analysis → ledger. And name the test for next week.', note: 'Unter 6/10 heißt: Woche 3 bleibt auf Teil 2, Sprachbausteine rutschen.' },
  ...
  },
  {
    ...
    slots: [
      ...
      { place: 'sofa', minutes: 35, datei: 'telc-b1-schule-1-hoerverstehen.mp3', what: 'Teil 2 kalt, mit Uhr → Antworten an mich.', en: 'Teil 2 cold, on the clock → answers to me.' },
  ...
  },
  {
    ...
    slots: [
      { place: 'gym', minutes: 15, datei: 'telc-b1-schule-1-hoerverstehen.mp3', what: 'Teil 2 noch einmal, ohne Papier.', en: 'Teil 2 once more, without paper.' },
      { place: 'sofa', minutes: 35, datei: 'telc-b1-schule-1-hoerverstehen.mp3', karten: ['koll'], what: 'Wiederholung mit Blatt, dann Kollokationen aus dem Ledger.', en: 'Repeat with the sheet, then collocations from the ledger.' },
  ...
  },
  {
    ...
    slots: [
      ...
      { place: 'sofa', minutes: 40, what: 'Brief auf Zeit, handschriftlich. Danach zeige ich dir den Aufbau der mündlichen Prüfung — geübt wird sie im Kurs.', en: 'Timed letter, by hand. Then I show you the shape of the oral exam — you practise it in class.' },
    ],
    deck: ['brief', 'gramm'],
  },
  {
  ...
  },
  {
    ...
    slots: [
      { place: 'gym', minutes: 10, karten: true, what: 'Kartenrunde <b>Brief</b>.', en: 'Card round: letter.' },
      { place: 'sofa', minutes: 35, what: '30 Minuten, handschriftlich, abfotografieren, an mich.', en: '30 minutes, by hand, photograph it, send it to me.' },
  ...
  },
  {
    ...
    needs: ['Test', 'Papier'],
    slots: [
      { place: 'sofa', minutes: 180, what: 'LV 1–3, SB 1–2 und ein 30-Minuten-Brief. Drei Stunden, mit Uhr.', en: 'Reading 1–3, Sprachbausteine 1–2 and a 30-minute letter. Three hours, on the clock.' },
  ...
  },
  {
    ...
    slots: [
      ...
      { place: 'sofa', minutes: 35, dateien: true, karten: true, what: 'Mit Blatt, dann Wortschatz-Rettung für alles, was daran gescheitert ist.', en: 'With the sheet, then a vocabulary rescue for everything it failed on.' },
  ...
  },
  {
    ...
    slots: [
      { place: 'sofa', minutes: 210, datei: 'telc-b1-uebungstest-1-hoerverstehen.mp3', what: 'Dreieinhalb Stunden unter echten Bedingungen. Handy weg.', en: 'Three and a half hours under real conditions. Phone away.', note: 'Ziel: alle Teile ≥ 60 %, Hören ≥ 70 %.' },
  ...
  },
  {
    ...
    slots: [
      { place: 'gym', minutes: 10, karten: true, what: 'Kartenrunde, gemischt.', en: 'Card round, mixed.' },
      { place: 'sofa', minutes: 50, what: 'Volle Fehleranalyse. Am Ende: ein DIN-A4-Blatt mit allem, was offen ist. Dazu Gesprächsthemen für deinen Freund.', en: 'Full error analysis. At the end: one A4 sheet with everything still open, plus conversation topics for your friend.' },
