...
export const CARDS: Card[] = [
  ...
  { tag: 'falle', cue: 'Teil 1: 30 Sekunden, fünf Aussagen. Was tust du?', answer: 'Nicht lesen — <b>markieren</b>. In jeder Aussage nur das eine Wort, an dem sie hängt.', meaning: "Don't read for meaning — mark the hinge. Six seconds a statement is enough to see what each one turns on, never enough to translate it.", example: 'Danach wartest du beim Hören auf fünf <b>Signale</b> statt auf fünf Sätze.', hint: '2026-08-15 · Teil 1 kalt 2/5' },
  { tag: 'falle', cue: 'Scharnier: meistens · oft · normalerweise · selten', answer: '<b>Häufigkeit.</b> Der Text muss sagen, <i>wie oft</i> — nicht <i>ob</i>.', meaning: 'Frequency hinge. The audio has to match how often, not whether it happens at all.', example: 'Er fährt <b>meistens</b> mit dem Zug — ein einziges Mal mit dem Auto widerlegt das nicht.' },
  { tag: 'falle', cue: 'Scharnier: trotz · obwohl · trotzdem', answer: '<b>Einräumung.</b> Zwei Hälften — es gilt die zweite.', meaning: 'Concession. Two halves, and only the second one is what the statement actually claims.', example: '„<b>Trotz</b> des Regens war es schön" ist richtig, wenn es schön war. Der Regen ist Kulisse.' },
  { tag: 'falle', cue: 'Scharnier: lieber · am liebsten · statt', answer: '<b>Präferenz.</b> A <i>gegen</i> B — nicht A allein.', meaning: 'Preference. The claim compares two options; both sides have to be in the audio.', example: 'Er verreist <b>lieber</b> allein <b>als</b> mit Freunden. „Er reist gern allein" reicht nicht.' },
  { tag: 'falle', cue: 'Scharnier: mehr · weniger · als geplant', answer: '<b>Vergleich.</b> Hör auf die <i>Richtung</i>, nicht auf die Zahl.', meaning: 'Comparison. Listen for the direction of the difference — the number itself is usually a decoy.', example: 'Der Aufenthalt kostete <b>weniger</b> als geplant. Teurer geworden? Dann falsch.' },
  { tag: 'falle', cue: 'Wie oft hörst du Teil 1?', answer: '<b>Nur einmal.</b> Teil 2 und Teil 3 zweimal.', meaning: 'Teil 1 plays once. A statement you are still decoding while it runs is a statement you have already lost.', example: 'Darum die 30 Sekunden davor — es ist die einzige Vorbereitung, die du bekommst.', hint: 'Testheft: „Sie hören diese Texte nur einmal."' },
